...
export default function SchoolNav() {
  ...
  return (
    <div className="fixed inset-x-0 top-0 z-50 px-4 pt-4 md:px-8">
      <div className="mx-auto max-w-7xl rounded-[28px] border border-primary/10 bg-[linear-gradient(135deg,hsl(var(--card)),hsl(var(--background)))] px-4 py-3 shadow-[var(--shadow-1)] backdrop-blur-xl">
